...
"001",979,,,,,,,,1,[[,"(\\d)(\\d{4})(\\d{4})","$1 $2 $3"]],,[,,"NA","NA",,,,,,[-1]],,,[,,"NA","NA",,,,,,[-1]],[,,"NA","NA",,,,,,[-1]],1,,[,,"NA","NA",,,,,,[-1]]]};var q=Array.prototype,r=q.indexOf?function(a,b,c){return q.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(k(a))return k(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},ca=q.filter?function(a,b,c){return q.filter.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=[],f=0,g=k(a)?a.split(""):a,h=0;h<d;h++)if(h in g){var m=g[h];b.call(c,m,h,a)&&(e[f++]=m)}return e};function da(a,b){a.sort(b||ea)}
...
function D(){t.call(this)}n(D,t);var sa=null;function E(){t.call(this)}n(E,t);var ta=null;function F(){t.call(this)}n(F,t);var ua=null;
D.prototype.h=function(){var a=sa;a||(sa=a=ra(D,{0:{name:"NumberFormat",da:"i18n.phonenumbers.NumberFormat"},1:{name:"pattern",required:!0,c:9,type:String},2:{name:"format",required:!0,c:9,type:String},3:{name:"leading_digits_pattern",v:!0,c:9,type:String},4:{name:"national_prefix_formatting_rule",c:9,type:String},6:{name:"national_prefix_optional_when_formatting",c:8,type:Boolean},5:{name:"domestic_carrier_code_formatting_rule",c:9,type:String}}));return a};D.h=D.prototype.h;
E.prototype.h=function(){var a=ta;a||(ta=a=ra(E,{0:{name:"PhoneNumberDesc",da:"i18n.phonenumbers.PhoneNumberDesc"},2:{name:"national_number_pattern",c:9,type:String},3:{name:"possible_number_pattern",c:9,type:String},9:{name:"possible_length",v:!0,c:5,type:Number},10:{name:"possible_length_local_only",v:!0,c:5,type:Number},6:{name:"example_number",c:9,type:String},7:{name:"national_number_matcher_data",c:12,type:String},8:{name:"possible_number_matcher_data",c:12,type:String}}));return a};E.h=E.prototype.h;
F.prototype.h=function(){var a=ua;a||(ua=a=ra(F,{0:{name:"PhoneMetadata",da:"i18n.phonenumbers.PhoneMetadata"},1:{name:"general_desc",c:11,type:E},2:{name:"fixed_line",c:11,type:E},3:{name:"mobile",c:11,type:E},4:{name:"toll_free",c:11,type:E},5:{name:"premium_rate",c:11,type:E},6:{name:"shared_cost",c:11,type:E},7:{name:"personal_number",c:11,type:E},8:{name:"voip",c:11,type:E},21:{name:"pager",c:11,type:E},25:{name:"uan",c:11,type:E},27:{name:"emergency",c:11,type:E},28:{name:"voicemail",c:11,type:E},
...
f=e.toString();if(!(O(c)||null!=f&&0<f.length&&L.test(f)))throw"Invalid country calling code";f=new G;d&&x(f,5,b);a:{b=e.toString();g=b.search(Ja);if(0<=g&&Ra(b.substring(0,g)))for(var h=b.match(Ja),m=h.length,v=1;v<m;++v)if(null!=h[v]&&0<h[v].length){I(e);e.a(b.substring(0,g));b=h[v];break a}b=""}0<b.length&&x(f,3,b);b=V(a,c);g=new H;h=0;m=e.toString();try{h=mb(m,b,g,d,f)}catch(P){if("Invalid country calling code"==P&&L.test(m)){if(m=m.replace(L,""),h=mb(m,b,g,d,f),!h)throw P;}else throw P;}h?(e=
...
1;a<d.length-1&&"0"==d.charAt(a);)a++;1!=a&&x(f,8,a)}x(f,2,parseInt(d,10));return f}function pb(a,b){var c=V(a,eb(a,b));if(!c)return!0;var d=R(b);return!W(d,w(c,24))}function M(a,b){var c="string"==typeof a?b.match("^(?:"+a+")$"):b.match(a);return c&&c[0].length==b.length?!0:!1};function qb(a){this.ea=RegExp("\u2008");this.s="";this.o=new H;this.$="";this.i=new H;this.l=new H;this.j=!0;this.aa=this.u=this.ga=!1;this.ba=J.a();this.ia=this.ha=this.w=0;this.b=new H;this.ca=!1;this.m="";this.a=new H;this.f=[];this.fa=a;this.g=rb(this,this.fa)}var sb=new F;x(sb,11,"NA");
